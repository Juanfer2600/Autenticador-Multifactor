...
<head>
  ...
  <style>
    .step-indicator { list-style: none; padding: 0; margin: 0 0 1.5rem; display: flex; justify-content: space-between; }
    .step-indicator li { flex: 1; text-align: center; position: relative; }
    .step-indicator li::after { content: ''; position: absolute; top: 50%; right: -50%; width: 100%; height: 2px; background: #ddd; z-index: -1; }
    .step-indicator li:last-child::after { display: none; }
    .step-indicator .step { display: inline-block; width: 2rem; height: 2rem; line-height: 2rem; border-radius: 50%; background: #ddd; color: #fff; margin-bottom: .5rem; }
    .step-indicator .active .step { background: #0d6efd; }
    .step-indicator .active span { font-weight: bold; }
    .step-indicator .label { display: block; font-size: .9rem; color: #666; }
    .step-indicator .active .label { color: #000; font-weight: 500; }
  </style>
</head>
<body class="bg-light">
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <input type="email" id="emailaddress" name="username"
                           class="form-control" placeholder="tu@ejemplo.com" required
