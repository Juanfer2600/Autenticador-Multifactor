...
(function (global, factory) {
  ...
  var IFrame = /*#__PURE__*/ (function () {
    ...
    _proto.openTabSidebar = function openTabSidebar(item, autoOpen) {
      ...
      // Verificar si el elemento tiene un data-panel
      var panelId = $item.attr('data-panel');
      if (panelId) {
        // Si el panel ya existe, solo cambiar a esa pestaña
        var existingPanel = $__default["default"]("#" + panelId);
        if (existingPanel.length > 0) {
          this.switchTab("#tab-" + panelId.replace("panel-", ""));
          return;
        }
      }
  ...
  var SidebarSearch = /*#__PURE__*/ (function () {
    ...
    _proto.open = function open() {
      ...
      $__default["default"](
        this._config.target + " " + SELECTOR_SEARCH_INPUT$1
      ).focus();
    };
